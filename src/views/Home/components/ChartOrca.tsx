...
const ChartOrca = (width, height) => {
    ...
    const chart = createChart("orca_chart_body_spec", {
        width,
        height,
        layout: {
  ...
  }, [created, setCreated, targetRef, width, height]);

  return (
        <div ref={targetRef} id="orca_chart_body_spec" />
  )
}

export default ChartOrca
